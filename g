...
g++    -c -g -std=c++11 -MMD -MP -MF "build/Debug/GNU-Linux-x86/petition-parser.o.d" -o build/Debug/GNU-Linux-x86/file-regex-parser.o file-regex-parser.cpp
...
g++     -o dist/Debug/GNU-Linux-x86/cpp-csv-extractor  build/Debug/GNU-Linux-x86/db_credentials.o  build/Debug/GNU-Linux-x86/file-regex-parser.o build/Debug/GNU-Linux-x86/petition-parser.o build/Debug/GNU-Linux-x86/main.o -lmysqlcppconn -lmysqlcppconn-static 
